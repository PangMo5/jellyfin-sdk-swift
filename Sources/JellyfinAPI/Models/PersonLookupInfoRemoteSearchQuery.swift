...
public struct PersonLookupInfoRemoteSearchQuery: Codable, JSONEncodable, Hashable {
    ...
    public init(searchInfo: PersonLookupInfoRemoteSearchQuerySearchInfo? = nil, itemId: String? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {

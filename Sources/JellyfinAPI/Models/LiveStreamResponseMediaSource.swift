//
// LiveStreamResponseMediaSource.swift
//
...
public struct LiveStreamResponseMediaSource: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(readAtNativeFramerate, forKey: .readAtNativeFramerate)
        try container.encodeIfPresent(ignoreDts, forKey: .ignoreDts)
        try container.encodeIfPresent(ignoreIndex, forKey: .ignoreIndex)
        try container.encodeIfPresent(genPtsInput, forKey: .genPtsInput)
        try container.encodeIfPresent(supportsTranscoding, forKey: .supportsTranscoding)
        try container.encodeIfPresent(supportsDirectStream, forKey: .supportsDirectStream)
        try container.encodeIfPresent(supportsDirectPlay, forKey: .supportsDirectPlay)
        try container.encodeIfPresent(isInfiniteStream, forKey: .isInfiniteStream)
        try container.encodeIfPresent(requiresOpening, forKey: .requiresOpening)
        try container.encodeIfPresent(openToken, forKey: .openToken)
        try container.encodeIfPresent(requiresClosing, forKey: .requiresClosing)
        try container.encodeIfPresent(liveStreamId, forKey: .liveStreamId)
        try container.encodeIfPresent(bufferMs, forKey: .bufferMs)
        try container.encodeIfPresent(requiresLooping, forKey: .requiresLooping)
        try container.encodeIfPresent(supportsProbing, forKey: .supportsProbing)
        ...
        try container.encodeIfPresent(requiredHttpHeaders, forKey: .requiredHttpHeaders)
        try container.encodeIfPresent(transcodingUrl, forKey: .transcodingUrl)
        try container.encodeIfPresent(transcodingSubProtocol, forKey: .transcodingSubProtocol)
        try container.encodeIfPresent(transcodingContainer, forKey: .transcodingContainer)
        try container.encodeIfPresent(analyzeDurationMs, forKey: .analyzeDurationMs)
        try container.encodeIfPresent(defaultAudioStreamIndex, forKey: .defaultAudioStreamIndex)
        try container.encodeIfPresent(defaultSubtitleStreamIndex, forKey: .defaultSubtitleStreamIndex)
    }
}

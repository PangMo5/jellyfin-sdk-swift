//
// GetSeriesRemoteSearchResultsRequest.swift
//
...
public struct GetSeriesRemoteSearchResultsRequest: Codable, JSONEncodable, Hashable {

    public var searchInfo: SeriesInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: SeriesInfoRemoteSearchQuerySearchInfo? = nil, itemId: String? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {

//
// GetBoxSetRemoteSearchResultsRequest.swift
//
...
public struct GetBoxSetRemoteSearchResultsRequest: Codable, JSONEncodable, Hashable {

    public var searchInfo: BoxSetInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: BoxSetInfoRemoteSearchQuerySearchInfo? = nil, itemId: String? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {

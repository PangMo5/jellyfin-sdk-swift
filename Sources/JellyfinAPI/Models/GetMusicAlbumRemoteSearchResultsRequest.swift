//
// GetMusicAlbumRemoteSearchResultsRequest.swift
//
...
public struct GetMusicAlbumRemoteSearchResultsRequest: Codable, JSONEncodable, Hashable {

    public var searchInfo: AlbumInfoRemoteSearchQuerySearchInfo?
    ...
    public init(searchInfo: AlbumInfoRemoteSearchQuerySearchInfo? = nil, itemId: String? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {

...
open class NotificationsAPI {
    ...
    open class func createAdminNotification(createAdminNotificationRequest: CreateAdminNotificationRequest, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            createAdminNotificationWithRequestBuilder(createAdminNotificationRequest: createAdminNotificationRequest).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
    ...
    open class func createAdminNotificationWithRequestBuilder(createAdminNotificationRequest: CreateAdminNotificationRequest) -> RequestBuilder<Void> {
        ...
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: createAdminNotificationRequest)

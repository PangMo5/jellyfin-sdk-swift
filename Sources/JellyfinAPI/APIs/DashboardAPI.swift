...
open class DashboardAPI {
    ...
    open class func getConfigurationPages(enableInMainMenu: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<[ConfigurationPageInfo], Error> {
        return Future<[ConfigurationPageInfo], Error>.init { promise in
            getConfigurationPagesWithRequestBuilder(enableInMainMenu: enableInMainMenu).execute(apiResponseQueue) { result -> Void in
                switch result {

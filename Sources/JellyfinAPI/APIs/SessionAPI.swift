...
open class SessionAPI {
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func displayContent(sessionId: String, itemType: BaseItemKind, itemId: String, itemName: String, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postFullCapabilities(postFullCapabilitiesRequest: PostFullCapabilitiesRequest, id: String? = nil, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            postFullCapabilitiesWithRequestBuilder(postFullCapabilitiesRequest: postFullCapabilitiesRequest, id: id).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
                case let .failure(error):
    ...
    open class func postFullCapabilitiesWithRequestBuilder(postFullCapabilitiesRequest: PostFullCapabilitiesRequest, id: String? = nil) -> RequestBuilder<Void> {
        ...
        let URLString = JellyfinAPI.basePath + urlPath
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: postFullCapabilitiesRequest)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func sendFullGeneralCommand(sessionId: String, sendFullGeneralCommandRequest: SendFullGeneralCommandRequest, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            sendFullGeneralCommandWithRequestBuilder(sessionId: sessionId, sendFullGeneralCommandRequest: sendFullGeneralCommandRequest).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
                case let .failure(error):
    ...
    open class func sendFullGeneralCommandWithRequestBuilder(sessionId: String, sendFullGeneralCommandRequest: SendFullGeneralCommandRequest) -> RequestBuilder<Void> {
        ...
        urlPath = urlPath.replacingOccurrences(of: "{sessionId}", with: sessionIdPostEscape, options: .literal, range: nil)
        let URLString = JellyfinAPI.basePath + urlPath
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: sendFullGeneralCommandRequest)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func sendMessageCommand(sessionId: String, sendMessageCommandRequest: SendMessageCommandRequest, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            sendMessageCommandWithRequestBuilder(sessionId: sessionId, sendMessageCommandRequest: sendMessageCommandRequest).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
                case let .failure(error):
    ...
    open class func sendMessageCommandWithRequestBuilder(sessionId: String, sendMessageCommandRequest: SendMessageCommandRequest) -> RequestBuilder<Void> {
        ...
        urlPath = urlPath.replacingOccurrences(of: "{sessionId}", with: sessionIdPostEscape, options: .literal, range: nil)
        let URLString = JellyfinAPI.basePath + urlPath
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: sendMessageCommandRequest)

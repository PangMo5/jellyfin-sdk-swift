...
open class LibraryStructureAPI {
    ...
    open class func addMediaPath(addMediaPathRequest: AddMediaPathRequest, refreshLibrary: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            addMediaPathWithRequestBuilder(addMediaPathRequest: addMediaPathRequest, refreshLibrary: refreshLibrary).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
    ...
    open class func addMediaPathWithRequestBuilder(addMediaPathRequest: AddMediaPathRequest, refreshLibrary: Bool? = nil) -> RequestBuilder<Void> {
        ...
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: addMediaPathRequest)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func addVirtualFolder(name: String? = nil, collectionType: CollectionTypeOptions? = nil, paths: [String]? = nil, refreshLibrary: Bool? = nil, addVirtualFolderRequest: AddVirtualFolderRequest? = nil, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            addVirtualFolderWithRequestBuilder(name: name, collectionType: collectionType, paths: paths, refreshLibrary: refreshLibrary, addVirtualFolderRequest: addVirtualFolderRequest).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
                case let .failure(error):
    ...
    open class func addVirtualFolderWithRequestBuilder(name: String? = nil, collectionType: CollectionTypeOptions? = nil, paths: [String]? = nil, refreshLibrary: Bool? = nil, addVirtualFolderRequest: AddVirtualFolderRequest? = nil) -> RequestBuilder<Void> {
        ...
        let URLString = JellyfinAPI.basePath + urlPath
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: addVirtualFolderRequest)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func updateLibraryOptions(updateLibraryOptionsRequest: UpdateLibraryOptionsRequest? = nil, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            updateLibraryOptionsWithRequestBuilder(updateLibraryOptionsRequest: updateLibraryOptionsRequest).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
                case let .failure(error):
    ...
    open class func updateLibraryOptionsWithRequestBuilder(updateLibraryOptionsRequest: UpdateLibraryOptionsRequest? = nil) -> RequestBuilder<Void> {
        ...
        let URLString = JellyfinAPI.basePath + urlPath
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: updateLibraryOptionsRequest)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func updateMediaPath(updateMediaPathRequest: UpdateMediaPathRequest, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
            updateMediaPathWithRequestBuilder(updateMediaPathRequest: updateMediaPathRequest).execute(apiResponseQueue) { result -> Void in
                switch result {
                case .success:
                    promise(.success(()))
                case let .failure(error):
    ...
    open class func updateMediaPathWithRequestBuilder(updateMediaPathRequest: UpdateMediaPathRequest) -> RequestBuilder<Void> {
        ...
        let URLString = JellyfinAPI.basePath + urlPath
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: updateMediaPathRequest)

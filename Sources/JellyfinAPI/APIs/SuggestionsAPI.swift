...
open class SuggestionsAPI {
    ...
    open class func getSuggestions(userId: String, mediaType: [String]? = nil, type: [BaseItemKind]? = nil, startIndex: Int? = nil, limit: Int? = nil, enableTotalRecordCount: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinAPI.apiResponseQueue) -> AnyPublisher<BaseItemDtoQueryResult, Error> {

...
public struct SeriesTimerInfoDtoQueryResultModel: APIModel {

    /** Gets or sets the items. */
    public var items: [SeriesTimerInfoDtoModel]?
    ...
    public init(items: [SeriesTimerInfoDtoModel]? = nil, startIndex: Int? = nil, totalRecordCount: Int? = nil) {
        self.items = items

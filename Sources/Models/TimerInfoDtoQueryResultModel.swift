...
public struct TimerInfoDtoQueryResultModel: APIModel {

    /** Gets or sets the items. */
    public var items: [TimerInfoDtoModel]?
    ...
    public init(items: [TimerInfoDtoModel]? = nil, startIndex: Int? = nil, totalRecordCount: Int? = nil) {
        self.items = items

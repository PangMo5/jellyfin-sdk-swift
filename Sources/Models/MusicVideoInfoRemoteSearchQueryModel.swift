...
public struct MusicVideoInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: MusicVideoInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: MusicVideoInfoModel? = nil, searchProviderName: String? = nil) {

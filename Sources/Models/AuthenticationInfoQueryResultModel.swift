...
public struct AuthenticationInfoQueryResultModel: APIModel {

    /** Gets or sets the items. */
    public var items: [AuthenticationInfoModel]?
    ...
    public init(items: [AuthenticationInfoModel]? = nil, startIndex: Int? = nil, totalRecordCount: Int? = nil) {
        self.items = items

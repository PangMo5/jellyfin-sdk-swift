...
public struct BookInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: BookInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: BookInfoModel? = nil, searchProviderName: String? = nil) {

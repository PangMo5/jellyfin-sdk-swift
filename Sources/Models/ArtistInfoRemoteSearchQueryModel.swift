...
public struct ArtistInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: ArtistInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: ArtistInfoModel? = nil, searchProviderName: String? = nil) {

...
public struct MovieInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: MovieInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: MovieInfoModel? = nil, searchProviderName: String? = nil) {

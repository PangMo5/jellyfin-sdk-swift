...
public struct DeviceInfoQueryResultModel: APIModel {

    /** Gets or sets the items. */
    public var items: [DeviceInfoModel]?
    ...
    public init(items: [DeviceInfoModel]? = nil, startIndex: Int? = nil, totalRecordCount: Int? = nil) {
        self.items = items

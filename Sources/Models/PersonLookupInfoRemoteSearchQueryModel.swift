...
public struct PersonLookupInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: PersonLookupInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: PersonLookupInfoModel? = nil, searchProviderName: String? = nil) {

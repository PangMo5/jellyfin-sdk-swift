...
public struct ArtistInfoModel: APIModel {
    ...
    public init(indexNumber: Int? = nil, isAutomated: Bool? = nil, metadataCountryCode: String? = nil, metadataLanguage: String? = nil, name: String? = nil, parentIndexNumber: Int? = nil, path: String? = nil, premiereDate: DateTime? = nil, providerIds: [String: String]? = nil, songInfos: [SongInfoModel]? = nil, year: Int? = nil) {

...
public struct BoxSetInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: BoxSetInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: BoxSetInfoModel? = nil, searchProviderName: String? = nil) {

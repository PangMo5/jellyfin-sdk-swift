...
public struct MusicVideoInfoModel: APIModel {
    ...
    public init(artists: [String]? = nil, indexNumber: Int? = nil, isAutomated: Bool? = nil, metadataCountryCode: String? = nil, metadataLanguage: String? = nil, name: String? = nil, parentIndexNumber: Int? = nil, path: String? = nil, premiereDate: DateTime? = nil, providerIds: [String: String]? = nil, year: Int? = nil) {

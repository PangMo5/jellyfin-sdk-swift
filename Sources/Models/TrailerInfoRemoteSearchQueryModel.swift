...
public struct TrailerInfoRemoteSearchQueryModel: APIModel {
    ...
    public var searchInfo: TrailerInfoModel?

    /** Will only search within the given provider when set. */
    public var searchProviderName: String?

    public init(includeDisabledProviders: Bool? = nil, itemId: ID? = nil, searchInfo: TrailerInfoModel? = nil, searchProviderName: String? = nil) {

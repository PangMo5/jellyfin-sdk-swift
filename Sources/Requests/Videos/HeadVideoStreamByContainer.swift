...
extension JellyfinAPI.Videos {
    ...
    /** Gets a video stream. */
    public enum HeadVideoStreamByContainer {

        public static let service = APIService<Response>(id: "HeadVideoStreamByContainer", tag: "Videos", method: "HEAD", path: "/Videos/{itemId}/stream.{container}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadVideoStreamByContainer.service)
            }

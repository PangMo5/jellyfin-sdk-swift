...
extension JellyfinAPI.Videos {
    ...
    /** Gets a video stream. */
    public enum GetVideoStream {

        public static let service = APIService<Response>(id: "GetVideoStream", tag: "Videos", method: "GET", path: "/Videos/{itemId}/stream", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetVideoStream.service)
            }

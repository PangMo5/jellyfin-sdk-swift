...
extension JellyfinAPI.Videos {
    ...
    public enum DeleteAlternateSources {

        public static let service = APIService<Response>(id: "DeleteAlternateSources", tag: "Videos", method: "DELETE", path: "/Videos/{itemId}/AlternateSources", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteAlternateSources.service)
            }

...
extension JellyfinAPI.Videos {
    ...
    /** Gets a video stream. */
    public enum GetVideoStreamByContainer {

        public static let service = APIService<Response>(id: "GetVideoStreamByContainer", tag: "Videos", method: "GET", path: "/Videos/{itemId}/stream.{container}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetVideoStreamByContainer.service)
            }

...
extension JellyfinAPI.Artists {
    ...
    public enum GetArtistByName {
        ...
        public static let service = APIService<Response>(id: "GetArtistByName", tag: "Artists", method: "GET", path: "/Artists/{name}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetArtistByName.service)
            }

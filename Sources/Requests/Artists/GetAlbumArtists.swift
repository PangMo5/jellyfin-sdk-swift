...
extension JellyfinAPI.Artists {
    ...
    public enum GetAlbumArtists {

        public static let service = APIService<Response>(id: "GetAlbumArtists", tag: "Artists", method: "GET", path: "/Artists/AlbumArtists", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetAlbumArtists.service)
            }

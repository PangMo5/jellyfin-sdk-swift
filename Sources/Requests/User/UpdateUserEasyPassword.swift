...
extension JellyfinAPI.User {
    ...
    public enum UpdateUserEasyPassword {

        public static let service = APIService<Response>(id: "UpdateUserEasyPassword", tag: "User", method: "POST", path: "/Users/{userId}/EasyPassword", hasBody: true, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: UpdateUserEasyPasswordModel

            public init(body: UpdateUserEasyPasswordModel, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: UpdateUserEasyPassword.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(userId: ID, body: UpdateUserEasyPasswordModel) {

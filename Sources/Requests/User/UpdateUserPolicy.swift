...
extension JellyfinAPI.User {
    ...
    public enum UpdateUserPolicy {

        public static let service = APIService<Response>(id: "UpdateUserPolicy", tag: "User", method: "POST", path: "/Users/{userId}/Policy", hasBody: true, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: UserPolicyModel

            public init(body: UserPolicyModel, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: UpdateUserPolicy.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(userId: ID, body: UserPolicyModel) {

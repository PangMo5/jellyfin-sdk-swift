...
extension JellyfinAPI.User {
    ...
    public enum UpdateUserPassword {

        public static let service = APIService<Response>(id: "UpdateUserPassword", tag: "User", method: "POST", path: "/Users/{userId}/Password", hasBody: true, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: UpdateUserPasswordModel

            public init(body: UpdateUserPasswordModel, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
                self.options = options
                super.init(service: UpdateUserPassword.service) { defaultEncoder in
                    return try (encoder ?? defaultEncoder).encode(body)
                }
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(userId: ID, body: UpdateUserPasswordModel) {

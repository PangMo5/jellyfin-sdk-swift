...
extension JellyfinAPI.User {
    ...
    public enum GetPublicUsers {

        public static let service = APIService<Response>(id: "GetPublicUsers", tag: "User", method: "GET", path: "/Users/Public", hasBody: false, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GetPublicUsers.service)
            }
        }

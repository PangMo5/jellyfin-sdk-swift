...
extension JellyfinAPI.User {
    ...
    public enum GetUserById {
        ...
        public static let service = APIService<Response>(id: "GetUserById", tag: "User", method: "GET", path: "/Users/{userId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["IgnoreParentalControl"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetUserById.service)
            }

...
extension JellyfinAPI.Studios {
    ...
    public enum GetStudio {

        public static let service = APIService<Response>(id: "GetStudio", tag: "Studios", method: "GET", path: "/Studios/{name}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetStudio.service)
            }

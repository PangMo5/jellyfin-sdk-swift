...
extension JellyfinAPI.Studios {

    /** Gets all studios from a given item, folder, or the entire library. */
    public enum GetStudios {

        public static let service = APIService<Response>(id: "GetStudios", tag: "Studios", method: "GET", path: "/Studios", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetStudios.service)
            }

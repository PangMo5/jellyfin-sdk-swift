...
extension JellyfinAPI.InstantMix {
    ...
    public enum GetInstantMixFromArtists {

        public static let service = APIService<Response>(id: "GetInstantMixFromArtists", tag: "InstantMix", method: "GET", path: "/Artists/{id}/InstantMix", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetInstantMixFromArtists.service)
            }

...
extension JellyfinAPI.InstantMix {
    ...
    public enum GetInstantMixFromPlaylist {

        public static let service = APIService<Response>(id: "GetInstantMixFromPlaylist", tag: "InstantMix", method: "GET", path: "/Playlists/{id}/InstantMix", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetInstantMixFromPlaylist.service)
            }

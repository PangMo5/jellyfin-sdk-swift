...
extension JellyfinAPI.InstantMix {
    ...
    public enum GetInstantMixFromItem {

        public static let service = APIService<Response>(id: "GetInstantMixFromItem", tag: "InstantMix", method: "GET", path: "/Items/{id}/InstantMix", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetInstantMixFromItem.service)
            }

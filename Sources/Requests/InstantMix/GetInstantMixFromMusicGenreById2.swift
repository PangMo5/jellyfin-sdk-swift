...
extension JellyfinAPI.InstantMix {
    ...
    public enum GetInstantMixFromMusicGenreById2 {

        public static let service = APIService<Response>(id: "GetInstantMixFromMusicGenreById2", tag: "InstantMix", method: "GET", path: "/MusicGenres/InstantMix", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetInstantMixFromMusicGenreById2.service)
            }

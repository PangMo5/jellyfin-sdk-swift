...
extension JellyfinAPI.InstantMix {
    ...
    public enum GetInstantMixFromArtists2 {

        public static let service = APIService<Response>(id: "GetInstantMixFromArtists2", tag: "InstantMix", method: "GET", path: "/Artists/InstantMix", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetInstantMixFromArtists2.service)
            }

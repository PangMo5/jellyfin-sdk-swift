...
extension JellyfinAPI.InstantMix {
    ...
    public enum GetInstantMixFromAlbum {

        public static let service = APIService<Response>(id: "GetInstantMixFromAlbum", tag: "InstantMix", method: "GET", path: "/Albums/{id}/InstantMix", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetInstantMixFromAlbum.service)
            }

...
extension JellyfinAPI.Dlna {
    ...
    public enum GetProfile {
        ...
        public static let service = APIService<Response>(id: "GetProfile", tag: "Dlna", method: "GET", path: "/Dlna/Profiles/{profileId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetProfile.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(profileId: String) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<DeviceProfileModel, ProblemDetailsModel> {

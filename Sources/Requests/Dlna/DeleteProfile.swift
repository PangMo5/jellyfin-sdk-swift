...
extension JellyfinAPI.Dlna {
    ...
    public enum DeleteProfile {
        ...
        public static let service = APIService<Response>(id: "DeleteProfile", tag: "Dlna", method: "DELETE", path: "/Dlna/Profiles/{profileId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteProfile.service)
            }

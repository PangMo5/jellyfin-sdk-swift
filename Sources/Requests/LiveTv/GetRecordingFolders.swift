...
extension JellyfinAPI.LiveTv {
    ...
    public enum GetRecordingFolders {

        public static let service = APIService<Response>(id: "GetRecordingFolders", tag: "LiveTv", method: "GET", path: "/LiveTv/Recordings/Folders", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetRecordingFolders.service)
            }

...
extension JellyfinAPI.LiveTv {
    ...
    /** Discover tuners. */
    public enum DiscoverTuners {

        public static let service = APIService<Response>(id: "DiscoverTuners", tag: "LiveTv", method: "GET", path: "/LiveTv/Tuners/Discover", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DiscoverTuners.service)
            }

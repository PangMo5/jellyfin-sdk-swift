...
extension JellyfinAPI.DynamicHls {
    ...
    public enum GetHlsVideoSegment {

        public static let service = APIService<Response>(id: "GetHlsVideoSegment", tag: "DynamicHls", method: "GET", path: "/Videos/{itemId}/hls1/{playlistId}/{segmentId}.{container}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])

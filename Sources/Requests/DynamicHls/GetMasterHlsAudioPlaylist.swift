...
extension JellyfinAPI.DynamicHls {
    ...
    public enum GetMasterHlsAudioPlaylist {

        public static let service = APIService<Response>(id: "GetMasterHlsAudioPlaylist", tag: "DynamicHls", method: "GET", path: "/Audio/{itemId}/master.m3u8", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMasterHlsAudioPlaylist.service)
            }

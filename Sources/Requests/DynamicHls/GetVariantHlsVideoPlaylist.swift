...
extension JellyfinAPI.DynamicHls {
    ...
    public enum GetVariantHlsVideoPlaylist {

        public static let service = APIService<Response>(id: "GetVariantHlsVideoPlaylist", tag: "DynamicHls", method: "GET", path: "/Videos/{itemId}/main.m3u8", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetVariantHlsVideoPlaylist.service)
            }

...
extension JellyfinAPI.DynamicHls {
    ...
    public enum GetVariantHlsAudioPlaylist {

        public static let service = APIService<Response>(id: "GetVariantHlsAudioPlaylist", tag: "DynamicHls", method: "GET", path: "/Audio/{itemId}/main.m3u8", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetVariantHlsAudioPlaylist.service)
            }

...
extension JellyfinAPI.DynamicHls {
    ...
    public enum GetMasterHlsVideoPlaylist {

        public static let service = APIService<Response>(id: "GetMasterHlsVideoPlaylist", tag: "DynamicHls", method: "GET", path: "/Videos/{itemId}/master.m3u8", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMasterHlsVideoPlaylist.service)
            }

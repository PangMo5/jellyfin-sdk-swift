...
extension JellyfinAPI.DynamicHls {
    ...
    public enum HeadMasterHlsAudioPlaylist {

        public static let service = APIService<Response>(id: "HeadMasterHlsAudioPlaylist", tag: "DynamicHls", method: "HEAD", path: "/Audio/{itemId}/master.m3u8", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadMasterHlsAudioPlaylist.service)
            }

...
extension JellyfinAPI.DynamicHls {
    ...
    public enum GetHlsAudioSegment {

        public static let service = APIService<Response>(id: "GetHlsAudioSegment", tag: "DynamicHls", method: "GET", path: "/Audio/{itemId}/hls1/{playlistId}/{segmentId}.{container}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetHlsAudioSegment.service)
            }

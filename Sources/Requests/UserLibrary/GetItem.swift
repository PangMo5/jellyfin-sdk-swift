...
extension JellyfinAPI.UserLibrary {
    ...
    public enum GetItem {
        ...
        public static let service = APIService<Response>(id: "GetItem", tag: "UserLibrary", method: "GET", path: "/Users/{userId}/Items/{itemId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])

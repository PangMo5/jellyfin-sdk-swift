...
extension JellyfinAPI.UserLibrary {
    ...
    public enum GetLocalTrailers {

        public static let service = APIService<Response>(id: "GetLocalTrailers", tag: "UserLibrary", method: "GET", path: "/Users/{userId}/Items/{itemId}/LocalTrailers", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetLocalTrailers.service)
            }

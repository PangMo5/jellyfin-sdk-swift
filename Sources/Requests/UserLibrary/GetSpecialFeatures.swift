...
extension JellyfinAPI.UserLibrary {
    ...
    public enum GetSpecialFeatures {

        public static let service = APIService<Response>(id: "GetSpecialFeatures", tag: "UserLibrary", method: "GET", path: "/Users/{userId}/Items/{itemId}/SpecialFeatures", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSpecialFeatures.service)
            }

...
extension JellyfinAPI.UserLibrary {
    ...
    /** Gets latest media. */
    public enum GetLatestMedia {

        public static let service = APIService<Response>(id: "GetLatestMedia", tag: "UserLibrary", method: "GET", path: "/Users/{userId}/Items/Latest", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(userId: ID, parentId: ID? = nil, fields: [ItemFields]? = nil, includeItemTypes: [String]? = nil, isPlayed: Bool? = nil, enableImages: Bool? = nil, imageTypeLimit: Int? = nil, enableImageTypes: [ImageType]? = nil, enableUserData: Bool? = nil, limit: Int? = nil, groupItems: Bool? = nil) {
                    self.userId = userId
            ...
            public init(options: Options) {
                ...
                super.init(service: GetLatestMedia.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(userId: ID, parentId: ID? = nil, fields: [ItemFields]? = nil, includeItemTypes: [String]? = nil, isPlayed: Bool? = nil, enableImages: Bool? = nil, imageTypeLimit: Int? = nil, enableImageTypes: [ImageType]? = nil, enableUserData: Bool? = nil, limit: Int? = nil, groupItems: Bool? = nil) {
                let options = Options(userId: userId, parentId: parentId, fields: fields, includeItemTypes: includeItemTypes, isPlayed: isPlayed, enableImages: enableImages, imageTypeLimit: imageTypeLimit, enableImageTypes: enableImageTypes, enableUserData: enableUserData, limit: limit, groupItems: groupItems)
            ...
            public override var queryParameters: [String: Any] {
                ...
                if let groupItems = options.groupItems {

...
extension JellyfinAPI.VideoHls {

    /** Gets a hls live stream. */
    public enum GetLiveHlsStream {

        public static let service = APIService<Response>(id: "GetLiveHlsStream", tag: "VideoHls", method: "GET", path: "/Videos/{itemId}/live.m3u8", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetLiveHlsStream.service)
            }
            ...
            public override var queryParameters: [String: Any] {
                ...
                if let enableSubtitlesInManifest = options.enableSubtitlesInManifest {
                  params["enableSubtitlesInManifest"] = enableSubtitlesInManifest
                }
                return params
            }
        }

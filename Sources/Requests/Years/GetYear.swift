...
extension JellyfinAPI.Years {
    ...
    public enum GetYear {
        ...
        public static let service = APIService<Response>(id: "GetYear", tag: "Years", method: "GET", path: "/Years/{year}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(year: Int, userId: ID? = nil) {
                    self.year = year
                    self.userId = userId
                }
            }
            ...
            public init(options: Options) {
                ...
                super.init(service: GetYear.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(year: Int, userId: ID? = nil) {
                let options = Options(year: year, userId: userId)

...
extension JellyfinAPI.ScheduledTasks {
    ...
    public enum StartTask {
        ...
        public static let service = APIService<Response>(id: "StartTask", tag: "ScheduledTasks", method: "POST", path: "/ScheduledTasks/Running/{taskId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: StartTask.service)
            }

...
extension JellyfinAPI.ScheduledTasks {
    ...
    /** Stop specified task. */
    public enum StopTask {

        public static let service = APIService<Response>(id: "StopTask", tag: "ScheduledTasks", method: "DELETE", path: "/ScheduledTasks/Running/{taskId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: StopTask.service)
            }

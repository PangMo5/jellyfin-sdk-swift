...
extension JellyfinAPI.Dashboard {
    ...
    public enum GetDashboardConfigurationPage {

        public static let service = APIService<Response>(id: "GetDashboardConfigurationPage", tag: "Dashboard", method: "GET", path: "/web/ConfigurationPage", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetDashboardConfigurationPage.service)
            }

...
extension JellyfinAPI.Image {
    ...
    public enum GetUserImageByIndex {

        public static let service = APIService<Response>(id: "GetUserImageByIndex", tag: "Image", method: "GET", path: "/Users/{userId}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetUserImageByIndex.service)
            }

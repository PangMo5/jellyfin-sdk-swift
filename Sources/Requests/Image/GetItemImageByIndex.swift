...
extension JellyfinAPI.Image {
    ...
    public enum GetItemImageByIndex {

        public static let service = APIService<Response>(id: "GetItemImageByIndex", tag: "Image", method: "GET", path: "/Items/{itemId}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetItemImageByIndex.service)
            }

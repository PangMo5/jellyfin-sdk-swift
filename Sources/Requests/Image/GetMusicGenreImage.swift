...
extension JellyfinAPI.Image {
    ...
    public enum GetMusicGenreImage {

        public static let service = APIService<Response>(id: "GetMusicGenreImage", tag: "Image", method: "GET", path: "/MusicGenres/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMusicGenreImage.service)
            }

...
extension JellyfinAPI.Image {
    ...
    public enum HeadMusicGenreImage {

        public static let service = APIService<Response>(id: "HeadMusicGenreImage", tag: "Image", method: "HEAD", path: "/MusicGenres/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadMusicGenreImage.service)
            }

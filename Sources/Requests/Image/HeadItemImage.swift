...
extension JellyfinAPI.Image {
    ...
    public enum HeadItemImage {

        public static let service = APIService<Response>(id: "HeadItemImage", tag: "Image", method: "HEAD", path: "/Items/{itemId}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadItemImage.service)
            }

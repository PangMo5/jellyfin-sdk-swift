...
extension JellyfinAPI.Image {
    ...
    public enum HeadStudioImageByIndex {

        public static let service = APIService<Response>(id: "HeadStudioImageByIndex", tag: "Image", method: "HEAD", path: "/Studios/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadStudioImageByIndex.service)
            }

...
extension JellyfinAPI.Image {
    ...
    public enum HeadGenreImage {

        public static let service = APIService<Response>(id: "HeadGenreImage", tag: "Image", method: "HEAD", path: "/Genres/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadGenreImage.service)
            }

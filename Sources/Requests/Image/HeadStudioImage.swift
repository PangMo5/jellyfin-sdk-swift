...
extension JellyfinAPI.Image {
    ...
    public enum HeadStudioImage {

        public static let service = APIService<Response>(id: "HeadStudioImage", tag: "Image", method: "HEAD", path: "/Studios/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadStudioImage.service)
            }

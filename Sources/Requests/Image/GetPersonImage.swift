...
extension JellyfinAPI.Image {
    ...
    public enum GetPersonImage {

        public static let service = APIService<Response>(id: "GetPersonImage", tag: "Image", method: "GET", path: "/Persons/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPersonImage.service)
            }

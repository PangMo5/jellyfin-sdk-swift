...
extension JellyfinAPI.Image {
    ...
    public enum GetGenreImage {

        public static let service = APIService<Response>(id: "GetGenreImage", tag: "Image", method: "GET", path: "/Genres/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetGenreImage.service)
            }

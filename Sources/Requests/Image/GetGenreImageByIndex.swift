...
extension JellyfinAPI.Image {
    ...
    public enum GetGenreImageByIndex {

        public static let service = APIService<Response>(id: "GetGenreImageByIndex", tag: "Image", method: "GET", path: "/Genres/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetGenreImageByIndex.service)
            }

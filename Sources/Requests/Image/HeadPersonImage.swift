...
extension JellyfinAPI.Image {
    ...
    public enum HeadPersonImage {

        public static let service = APIService<Response>(id: "HeadPersonImage", tag: "Image", method: "HEAD", path: "/Persons/{name}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadPersonImage.service)
            }

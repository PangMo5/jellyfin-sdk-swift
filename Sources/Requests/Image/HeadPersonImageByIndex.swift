...
extension JellyfinAPI.Image {
    ...
    public enum HeadPersonImageByIndex {

        public static let service = APIService<Response>(id: "HeadPersonImageByIndex", tag: "Image", method: "HEAD", path: "/Persons/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadPersonImageByIndex.service)
            }

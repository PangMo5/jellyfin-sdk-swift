...
extension JellyfinAPI.Image {
    ...
    public enum GetArtistImage {

        public static let service = APIService<Response>(id: "GetArtistImage", tag: "Image", method: "GET", path: "/Artists/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetArtistImage.service)
            }

...
extension JellyfinAPI.Image {
    ...
    public enum DeleteUserImage {

        public static let service = APIService<Response>(id: "DeleteUserImage", tag: "Image", method: "DELETE", path: "/Users/{userId}/Images/{imageType}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(userId: ID, imageType: ImageType, index: Int? = nil) {
                    self.userId = userId
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteUserImage.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(userId: ID, imageType: ImageType, index: Int? = nil) {

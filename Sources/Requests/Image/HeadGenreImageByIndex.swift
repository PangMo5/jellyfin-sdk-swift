...
extension JellyfinAPI.Image {
    ...
    public enum HeadGenreImageByIndex {

        public static let service = APIService<Response>(id: "HeadGenreImageByIndex", tag: "Image", method: "HEAD", path: "/Genres/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadGenreImageByIndex.service)
            }

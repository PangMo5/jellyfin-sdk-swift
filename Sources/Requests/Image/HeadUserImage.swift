...
extension JellyfinAPI.Image {
    ...
    public enum HeadUserImage {

        public static let service = APIService<Response>(id: "HeadUserImage", tag: "Image", method: "HEAD", path: "/Users/{userId}/Images/{imageType}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadUserImage.service)
            }

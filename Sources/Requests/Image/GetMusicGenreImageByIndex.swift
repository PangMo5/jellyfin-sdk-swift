...
extension JellyfinAPI.Image {
    ...
    public enum GetMusicGenreImageByIndex {

        public static let service = APIService<Response>(id: "GetMusicGenreImageByIndex", tag: "Image", method: "GET", path: "/MusicGenres/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMusicGenreImageByIndex.service)
            }

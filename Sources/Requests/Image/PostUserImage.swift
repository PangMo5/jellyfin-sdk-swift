...
extension JellyfinAPI.Image {
    ...
    /** Sets the user image. */
    public enum PostUserImage {

        public static let service = APIService<Response>(id: "PostUserImage", tag: "Image", method: "POST", path: "/Users/{userId}/Images/{imageType}", hasBody: true, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PostUserImage.service)
            }

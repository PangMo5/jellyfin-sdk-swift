...
extension JellyfinAPI.Image {
    ...
    public enum GetStudioImageByIndex {

        public static let service = APIService<Response>(id: "GetStudioImageByIndex", tag: "Image", method: "GET", path: "/Studios/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetStudioImageByIndex.service)
            }

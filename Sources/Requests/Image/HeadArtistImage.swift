...
extension JellyfinAPI.Image {
    ...
    public enum HeadArtistImage {

        public static let service = APIService<Response>(id: "HeadArtistImage", tag: "Image", method: "HEAD", path: "/Artists/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadArtistImage.service)
            }

...
extension JellyfinAPI.Image {
    ...
    public enum GetPersonImageByIndex {

        public static let service = APIService<Response>(id: "GetPersonImageByIndex", tag: "Image", method: "GET", path: "/Persons/{name}/Images/{imageType}/{imageIndex}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPersonImageByIndex.service)
            }

...
extension JellyfinAPI.Image {
    ...
    /** Sets the user image. */
    public enum PostUserImageByIndex {

        public static let service = APIService<Response>(id: "PostUserImageByIndex", tag: "Image", method: "POST", path: "/Users/{userId}/Images/{imageType}/{index}", hasBody: true, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PostUserImageByIndex.service)
            }

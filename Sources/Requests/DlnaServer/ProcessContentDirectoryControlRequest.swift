...
extension JellyfinAPI.DlnaServer {
    ...
    public enum ProcessContentDirectoryControlRequest {

        public static let service = APIService<Response>(id: "ProcessContentDirectoryControlRequest", tag: "DlnaServer", method: "POST", path: "/Dlna/{serverId}/ContentDirectory/Control", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProcessContentDirectoryControlRequest.service)
            }

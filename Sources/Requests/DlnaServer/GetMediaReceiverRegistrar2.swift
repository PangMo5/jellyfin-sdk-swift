...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetMediaReceiverRegistrar2 {

        public static let service = APIService<Response>(id: "GetMediaReceiverRegistrar_2", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/MediaReceiverRegistrar/MediaReceiverRegistrar", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMediaReceiverRegistrar2.service)
            }

...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetContentDirectory3 {

        public static let service = APIService<Response>(id: "GetContentDirectory_3", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/ContentDirectory/ContentDirectory.xml", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetContentDirectory3.service)
            }

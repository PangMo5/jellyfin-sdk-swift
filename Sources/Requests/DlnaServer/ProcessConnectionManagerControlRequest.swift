...
extension JellyfinAPI.DlnaServer {
    ...
    public enum ProcessConnectionManagerControlRequest {

        public static let service = APIService<Response>(id: "ProcessConnectionManagerControlRequest", tag: "DlnaServer", method: "POST", path: "/Dlna/{serverId}/ConnectionManager/Control", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProcessConnectionManagerControlRequest.service)
            }

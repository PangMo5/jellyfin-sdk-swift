...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetMediaReceiverRegistrar {

        public static let service = APIService<Response>(id: "GetMediaReceiverRegistrar", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/MediaReceiverRegistrar", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMediaReceiverRegistrar.service)
            }

...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetConnectionManager2 {

        public static let service = APIService<Response>(id: "GetConnectionManager_2", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/ConnectionManager/ConnectionManager", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetConnectionManager2.service)
            }

...
extension JellyfinAPI.DlnaServer {
    ...
    public enum ProcessMediaReceiverRegistrarControlRequest {

        public static let service = APIService<Response>(id: "ProcessMediaReceiverRegistrarControlRequest", tag: "DlnaServer", method: "POST", path: "/Dlna/{serverId}/MediaReceiverRegistrar/Control", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProcessMediaReceiverRegistrarControlRequest.service)
            }

...
extension JellyfinAPI.DlnaServer {
    ...
    /** Get Description Xml. */
    public enum GetDescriptionXml {

        public static let service = APIService<Response>(id: "GetDescriptionXml", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/description", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetDescriptionXml.service)
            }

...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetConnectionManager3 {

        public static let service = APIService<Response>(id: "GetConnectionManager_3", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/ConnectionManager/ConnectionManager.xml", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetConnectionManager3.service)
            }

...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetContentDirectory {

        public static let service = APIService<Response>(id: "GetContentDirectory", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/ContentDirectory", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetContentDirectory.service)
            }

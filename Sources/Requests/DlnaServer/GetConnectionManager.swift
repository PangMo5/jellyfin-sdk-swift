...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetConnectionManager {

        public static let service = APIService<Response>(id: "GetConnectionManager", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/ConnectionManager", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetConnectionManager.service)
            }

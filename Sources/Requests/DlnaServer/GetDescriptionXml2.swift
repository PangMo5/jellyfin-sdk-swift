...
extension JellyfinAPI.DlnaServer {
    ...
    /** Get Description Xml. */
    public enum GetDescriptionXml2 {

        public static let service = APIService<Response>(id: "GetDescriptionXml_2", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/description.xml", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetDescriptionXml2.service)
            }

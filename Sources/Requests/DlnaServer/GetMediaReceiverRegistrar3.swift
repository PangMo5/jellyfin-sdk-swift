...
extension JellyfinAPI.DlnaServer {
    ...
    public enum GetMediaReceiverRegistrar3 {

        public static let service = APIService<Response>(id: "GetMediaReceiverRegistrar_3", tag: "DlnaServer", method: "GET", path: "/Dlna/{serverId}/MediaReceiverRegistrar/MediaReceiverRegistrar.xml", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMediaReceiverRegistrar3.service)
            }

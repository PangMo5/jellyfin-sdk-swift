...
extension JellyfinAPI.Library {
    ...
    /** Gets similar items. */
    public enum GetSimilarShows {

        public static let service = APIService<Response>(id: "GetSimilarShows", tag: "Library", method: "GET", path: "/Shows/{itemId}/Similar", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSimilarShows.service)
            }

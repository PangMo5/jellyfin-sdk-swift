...
extension JellyfinAPI.Library {
    ...
    public enum GetDownload {
        ...
        public static let service = APIService<Response>(id: "GetDownload", tag: "Library", method: "GET", path: "/Items/{itemId}/Download", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["Download"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetDownload.service)
            }

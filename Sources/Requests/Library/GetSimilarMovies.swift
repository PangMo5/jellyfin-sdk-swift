...
extension JellyfinAPI.Library {
    ...
    /** Gets similar items. */
    public enum GetSimilarMovies {

        public static let service = APIService<Response>(id: "GetSimilarMovies", tag: "Library", method: "GET", path: "/Movies/{itemId}/Similar", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSimilarMovies.service)
            }

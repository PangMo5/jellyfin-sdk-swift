...
extension JellyfinAPI.Library {
    ...
    public enum GetMediaFolders {
        ...
        public static let service = APIService<Response>(id: "GetMediaFolders", tag: "Library", method: "GET", path: "/Library/MediaFolders", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMediaFolders.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(isHidden: Bool? = nil) {
                let options = Options(isHidden: isHidden)

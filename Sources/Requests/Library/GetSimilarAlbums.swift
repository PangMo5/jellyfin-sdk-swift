...
extension JellyfinAPI.Library {
    ...
    /** Gets similar items. */
    public enum GetSimilarAlbums {

        public static let service = APIService<Response>(id: "GetSimilarAlbums", tag: "Library", method: "GET", path: "/Albums/{itemId}/Similar", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSimilarAlbums.service)
            }

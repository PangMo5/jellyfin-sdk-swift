...
extension JellyfinAPI.Library {
    ...
    public enum GetFile {
        ...
        public static let service = APIService<Response>(id: "GetFile", tag: "Library", method: "GET", path: "/Items/{itemId}/File", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])

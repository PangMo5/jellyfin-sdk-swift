...
extension JellyfinAPI.Library {
    ...
    public enum GetCriticReviews {

        public static let service = APIService<Response>(id: "GetCriticReviews", tag: "Library", method: "GET", path: "/Items/{itemId}/CriticReviews", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetCriticReviews.service)
            }

...
extension JellyfinAPI.Library {
    ...
    /** Gets similar items. */
    public enum GetSimilarArtists {

        public static let service = APIService<Response>(id: "GetSimilarArtists", tag: "Library", method: "GET", path: "/Artists/{itemId}/Similar", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSimilarArtists.service)
            }

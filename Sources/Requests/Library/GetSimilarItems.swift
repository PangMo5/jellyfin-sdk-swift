...
extension JellyfinAPI.Library {
    ...
    /** Gets similar items. */
    public enum GetSimilarItems {

        public static let service = APIService<Response>(id: "GetSimilarItems", tag: "Library", method: "GET", path: "/Items/{itemId}/Similar", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetSimilarItems.service)
            }

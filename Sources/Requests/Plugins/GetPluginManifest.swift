...
extension JellyfinAPI.Plugins {
    ...
    public enum GetPluginManifest {

        public static let service = APIService<Response>(id: "GetPluginManifest", tag: "Plugins", method: "POST", path: "/Plugins/{pluginId}/Manifest", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPluginManifest.service)
            }

...
extension JellyfinAPI.Plugins {
    ...
    public enum UninstallPluginByVersion {

        public static let service = APIService<Response>(id: "UninstallPluginByVersion", tag: "Plugins", method: "DELETE", path: "/Plugins/{pluginId}/{version}", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation", "DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UninstallPluginByVersion.service)
            }

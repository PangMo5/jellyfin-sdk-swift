...
extension JellyfinAPI.Plugins {
    ...
    /** Disable a plugin. */
    public enum DisablePlugin {

        public static let service = APIService<Response>(id: "DisablePlugin", tag: "Plugins", method: "POST", path: "/Plugins/{pluginId}/{version}/Disable", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["RequiresElevation", "DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DisablePlugin.service)
            }

...
extension JellyfinAPI.Plugins {
    ...
    */
    public enum UpdatePluginConfiguration {

        public static let service = APIService<Response>(id: "UpdatePluginConfiguration", tag: "Plugins", method: "POST", path: "/Plugins/{pluginId}/Configuration", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UpdatePluginConfiguration.service)
            }

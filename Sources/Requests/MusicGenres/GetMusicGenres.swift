...
extension JellyfinAPI.MusicGenres {
    ...
    public enum GetMusicGenres {

        public static let service = APIService<Response>(id: "GetMusicGenres", tag: "MusicGenres", method: "GET", path: "/MusicGenres", hasBody: false, securityRequirements: [SecurityRequirement(type: "CustomAuthentication", scopes: ["DefaultAuthorization"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetMusicGenres.service)
            }

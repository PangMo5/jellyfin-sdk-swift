...
extension JellyfinAPI.Audio {

    /** Gets an audio stream. */
    public enum HeadAudioStreamByContainer {

        public static let service = APIService<Response>(id: "HeadAudioStreamByContainer", tag: "Audio", method: "HEAD", path: "/Audio/{itemId}/stream.{container}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadAudioStreamByContainer.service)
            }
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "itemId" + "}", with: "\(self.options.itemId.encode())").replacingOccurrences(of: "{" + "container" + "}", with: "\(self.options.container)")
            }

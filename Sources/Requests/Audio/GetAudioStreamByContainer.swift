...
extension JellyfinAPI.Audio {
    ...
    public enum GetAudioStreamByContainer {

        public static let service = APIService<Response>(id: "GetAudioStreamByContainer", tag: "Audio", method: "GET", path: "/Audio/{itemId}/stream.{container}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetAudioStreamByContainer.service)
            }

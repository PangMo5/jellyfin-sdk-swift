...
extension JellyfinAPI.Audio {
    ...
    public enum GetAudioStream {

        public static let service = APIService<Response>(id: "GetAudioStream", tag: "Audio", method: "GET", path: "/Audio/{itemId}/stream", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetAudioStream.service)
            }

...
extension JellyfinAPI.Audio {
    ...
    public enum HeadAudioStream {

        public static let service = APIService<Response>(id: "HeadAudioStream", tag: "Audio", method: "HEAD", path: "/Audio/{itemId}/stream", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: HeadAudioStream.service)
            }

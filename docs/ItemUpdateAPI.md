...
# **updateItem**
```swift
    open class func updateItem(itemId: String, updateItemRequest: UpdateItemRequest, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
